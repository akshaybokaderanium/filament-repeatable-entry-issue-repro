...
use App\Filament\Resources\ConsentOptionResource\Pages;
...
class ConsentOptionResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListConsentOptions::route('/'),
            'create' => Pages\CreateConsentOption::route('/create'),
            'edit' => Pages\EditConsentOption::route('/{record}/edit'),
        ];
    }
}
